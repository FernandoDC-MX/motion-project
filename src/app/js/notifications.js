class Notification{
    ...
    appendNotification(){
        ...
        _div.classList.add('notification','mb-1')

        let _body = document.createElement('div');
        _body.classList.add('notification-body')

        let _header = document.createElement('div');
        _header.classList.add('d-flex', 'notification-header', 'mb-1');

        switch(this.type){
            case 'success': _header.innerHTML = `
                                ...
                                <small class="mx-2">Completado correctamente</small>
                            `
                            _div.classList.add('notification-success')
                break;
            case 'error': _header.innerHTML = `
                                ...
                                <small class="mx-2">Error</small>
                            `;
                            _div.classList.add('notification-error')

                break;
            case 'warning': _header.innerHTML = `
                                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor" class="bi bi-exclamation-diamond" viewBox="0 0 16 16">
                                ...
                                <small class="mx-2">Advertencia</small>
                            `;

                            _div.classList.add('notification-warning')

                break;
            case 'info': _header.innerHTML = `
                            ...
                            <small class="mx-2">Información</small>
                        `;

                        _div.classList.add('notification-info')
                break;
        }
        ...
        _p.classList.add('notification-text');
        _p.innerText = this.message;
    ...
    async delete(notification){
        ...
        notification.style.animation = "fadeIn 0.2s ease-in-out forwards"
...
//     if(_notification.classList.length)
//         _notification.className = '';
    

//     switch(icon){
//         case 'success': _icon.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="bi bi-check-circle" viewBox="0 0 16 16"><path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"/><path d="M10.97 4.97a.235.235 0 0 0-.02.022L7.477 9.417 5.384 7.323a.75.75 0 0 0-1.06 1.06L6.97 11.03a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 0 0-1.071-1.05z"/></svg>`;
//                         _notification.classList.add('notification-success');
//             break;
//         case 'error': _icon.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="bi bi-x-circle" viewBox="0 0 16 16"><path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"/><path d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708z"/></svg>`;
//                       _notification.classList.add('notification-error');
//             break;
//         case 'info': _icon.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="bi bi-info-circle" viewBox="0 0 16 16"><path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"/><path d="m8.93 6.588-2.29.287-.082.38.45.083c.294.07.352.176.288.469l-.738 3.468c-.194.897.105 1.319.808 1.319.545 0 1.178-.252 1.465-.598l.088-.416c-.2.176-.492.246-.686.246-.275 0-.375-.193-.304-.533L8.93 6.588zM9 4.5a1 1 0 1 1-2 0 1 1 0 0 1 2 0z"/></svg>`;
//                      _notification.classList.add('notification-info');
//             break;
//         case 'warning': _icon.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="bi bi-exclamation-diamond" viewBox="0 0 16 16"><path d="M6.95.435c.58-.58 1.52-.58 2.1 0l6.515 6.516c.58.58.58 1.519 0 2.098L9.05 15.565c-.58.58-1.519.58-2.098 0L.435 9.05a1.482 1.482 0 0 1 0-2.098L6.95.435zm1.4.7a.495.495 0 0 0-.7 0L1.134 7.65a.495.495 0 0 0 0 .7l6.516 6.516a.495.495 0 0 0 .7 0l6.516-6.516a.495.495 0 0 0 0-.7L8.35 1.134z"/><path d="M7.002 11a1 1 0 1 1 2 0 1 1 0 0 1-2 0zM7.1 4.995a.905.905 0 1 1 1.8 0l-.35 3.507a.552.552 0 0 1-1.1 0L7.1 4.995z"/></svg>`;
//                         _notification.classList.add('notification-warning')
//             break;
//     }

//     _text.innerHTML = message;
//     _notification.style.animation = 'pop-swirl 1s ease forwards';

//     setTimeout(()=>{
//     _notification.style.animation = 'pop-out 0.7s ease forwards';
//     }, 2000)
// }
...
function show(type, message){
    let notification = new Notification(type, message)
    notification.appendNotification() 
}